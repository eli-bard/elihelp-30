...
export default function VasoactiveDrugCalculator() {
  ...
  const calculateDose = () => {
    ...
    // ESSES 4 SÃO OS QUE PRECISAMOS MODIFICAR PARA RESOLVER O PROBLEMA!?
    const dosechanged1 =
    ...
    const totalVolumeMl =
      (dosechanged2 * weightNum * timeFactor) / concentrationchanged2;
